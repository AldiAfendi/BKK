...
<!-- Mirrored from themesbrand.com/agroxa/layouts/blue/tables-editable.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 09 Feb 2022 06:33:27 GMT -->
<head>
        ...
        <link href="assets/libs/datatables.net-autoFill-bs4/css/autoFill.bootstrap4.min.html" rel="stylesheet"
            type="text/css" />
                ...
                <div data-simplebar class="h-100">
                    ...
                    <div id="sidebar-menu">
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <li>
                                <a href="rekapizin.html" class="waves-effect">
                            ...
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <div class="page-title">
                                        <h4 class="mb-0 font-size-18">REKAP IZIN SISWA</h4>
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active">XI-RPL</li>
                                        </ol>
                                    </div>
                                ...
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <p class="card-title-desc">SMK NEGERI 1 TAMBAKBOYO</p>

                                        <div class="row">
                                            <div class="col-lg-4">
                                                <div class="card bg-warning text-white-50">
                                                    <div class="card-body">
                                                        <h5 class="mb-4 text-white"><i class="ion ion-md-person me-3"></i>ALDI AFENDI</h5>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="card bg-danger text-white-50">
                                                    <div class="card-body">
                                                        <h5 class="mb-4 text-white"><i class="mdi mdi-block-helper me-3"></i>ALDI AFENDI</h5>
                                                        <p class="card-text">Some quick example text to build on the card title and make up
                                                            the bulk of the card's content.</p>
                                                    </div>
                                                    <!-- End Cardbody -->
...
<!-- Mirrored from themesbrand.com/agroxa/layouts/blue/tables-editable.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 09 Feb 2022 06:33:29 GMT -->
</html>