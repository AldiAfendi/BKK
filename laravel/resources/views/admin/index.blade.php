                        ...
                        <div class="page-content-wrapper">
                            <div class="row">
                                    ...
                                    <div class="card bg-primary mini-stat position-relative">
                                        <div class="card-body">
                                            <div class="mini-stat-desc">
                                                <h5 class="text-uppercase verti-label font-size-16 text-white-50">KERJA
                                                </h5>
                                                <div class="text-white">
                                                    <h5 class="text-uppercase font-size-16 text-white-50">KERJA</h5>
                                                    <h3 class="mb-3 text-white">1587</h3>
                                                </div>
                                ...
                                <div class="col-xl-3 col-md-6">
                                    <div class="card bg-primary mini-stat position-relative">
                                        <div class="card-body">
                                            <div class="mini-stat-desc">
                                                <h5 class="text-uppercase verti-label font-size-16 text-white-50">KULIAH
                                                </h5>
                                                <div class="text-white">
                                                    <h5 class="text-uppercase font-size-16 text-white-50">KULIAH</h5>
                                                    <h3 class="mb-3 text-white">4785</h3>
                                                </div>
                                                <div class="mini-stat-icon">
                                ...
                                <div class="col-xl-3 col-md-6">
                                    <div class="card bg-primary mini-stat position-relative">
                                        <div class="card-body">
                                            <div class="mini-stat-desc">
                                                <h5 class="text-uppercase verti-label font-size-16 text-white-50">WIRAUSAHA
                                                </h5>
                                                <div class="text-white">
                                                    <h5 class="text-uppercase font-size-16 text-white-50">WIRAUSAHA
                                                    </h5>
                                ...
                                <div class="col-xl-3 col-md-6">
                                    <div class="card bg-primary mini-stat position-relative">
                                        <div class="card-body">
                                            <div class="mini-stat-desc">
                                                <h5 class="text-uppercase verti-label font-size-16 text-white-50">ALUMNI
                                                </h5>
                                                <div class="text-white">
                                                    <h5 class="text-uppercase font-size-16 text-white-50">ALUMNI
                                                    </h5>
                            ...
                            <div class="row">
                                <div class="col-xl-6">
                                    <div class="card">
                                        <div class="card-body">
                                            <h4 class="card-title mb-4">Perusahaan</h4>
                                                ...
                                                <table class="table table-hover align-middle mb-0">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <th scope="row">1</th>
                                                            <td>Hummasoft</td>
                                                            <td>Kec.Karangoloso Kab.Malang</td>
                                                            <td>Afrizal Himawan</td>
                                                        </tr>
                                                        <tr>
                                                            <th scope="row">2</th>
                                                            <td>Axelbit</td>
                                ...
                                <div class="col-xl-6">
                                    <div class="card">
                                        <div class="card-body">
                                            <h4 class="card-title mb-4">Total Alumni</h4>
