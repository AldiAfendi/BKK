...
<head>
  ...
  <link href="aset/vendor/quill/quill.snow.css" rel="stylesheet">
  <link href="aset/vendor/quill/quill.bubble.css" rel="stylesheet">
  <link href="aset/vendor/remixicon/remixicon.css" rel="stylesheet">
  <link href="aset/vendor/simple-datatables/style.css" rel="stylesheet">
...
<body>
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="index.html" class="logo d-flex align-items-center w-auto">
                  ...
                  <span class="d-none d-lg-block">Kelompok 4</span>
                </a>
              </div><!-- End Logo -->
                  ...
                  <form class="row g-3 needs-validation" novalidate>
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        ...
                        <input type="email" name="email" id="email" class="form-control" id="yourUsername" value="{{ old('email') }}" required>
                    ...
                    <div class="col-12">
                      ...
                      <div class="invalid-feedback">Silahkan Masukkan Passowrd Terlebih Dahulu!!</div>
                    </div>
                    ...
                    <div class="col-12">
                      ...
                      <div class="invalid-feedback">Silahkan Konfirmasi Password Terlebih Dahulu!!</div>
                    </div>

                    <div class="col-12">
                      <div class="form-check">
                        <input class="form-check-input" name="terms" type="checkbox" value="" id="acceptTerms" required>
                        <label class="form-check-label" for="acceptTerms">Saya setuju <a href="#"> dan menerima syarat dan ketentuan</a></label>
                    ...
                    <div class="col-12">
                      <p class="small mb-0">Sudah Miliki Akun? <a href="pages-login.html">Login</a></p>
                    </div>
                  </form>
  ...
  <!-- Vendor JS Files -->
  <script src="aset/vendor/apexcharts/apexcharts.min.js"></script>
  <script src="aset/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
  <script src="aset/vendor/chart.js/chart.min.js"></script>
  <script src="aset/vendor/echarts/echarts.min.js"></script>
  <script src="aset/vendor/quill/quill.min.js"></script>
  <script src="aset/vendor/simple-datatables/simple-datatables.js"></script>
  <script src="aset/vendor/tinymce/tinymce.min.js"></script>
