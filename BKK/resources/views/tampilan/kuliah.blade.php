...
<body>
    ...
    <div class="page-wrapper">
                        ...
                        <div class="main-nav__left main-nav__left_one float-left">
                            <div class="logo_one">
                                <a href="index.html" class="main-nav__logo">
                                    <img src="assep/images/resources/logo.png" class="main-logo" alt="Awesome Image">
                                </a>
                            </div>
                        ...
                        <div class="main-nav__main-navigation one float-left">
                            <ul class=" main-nav__navigation-box">
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul>
                                        <li><a href="{{ url('bekerja') }}">BEKERJA</a></li>
                                        <li><a href="{{ url('kuliah') }}">KULIAH</a></li>
                                        <li><a href="{{ url('wirausaha') }}">WIRAUSAHA</a></li>
                                    </ul><!-- /.sub-menu -->
                                </li>
                            </ul>
                        </div><!-- /.navbar-collapse -->
        ...
        <section class="page-header" style="background-image: url(assep/images/backgrounds/page-header-contact.jpg);">
            <div class="container">
                <h2>cari alumni dari berbagai angkatan</h2>
            </div>
        </section>
                ...
                <div class="row">
                        ...
                        <div class="top_authors_single">
                            <div class="top_authors_single_inner">
                                <div class="top_authors_image">
                                    <img src="assep/images/resources/top-authors-img-1.jpg" alt="">
                                </div>
                            ...
                            <div class="top_authors_single_inner">
                                <div class="top_authors_image">
                                    <img src="assep/images/resources/top-authors-img-2.jpg" alt="">
                                </div>
                                <div class="top_authors_content">
                                    <h3>Sarah Albert</h3>
                                    <h4>Event organizer</h4>
                                    <div class="top_authors_text">
                                        <p>Lorem ipsum dolor sit amet consect adiping elit. Maecenas in pulvinar neque.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="top_authors_single_inner">
                                <div class="top_authors_image">
                                    <img src="assep/images/resources/top-authors-img-3.jpg" alt="">
                                </div>
                                <div class="top_authors_content">
                                    <h3>John Smith</h3>
                    ...
                    <div class="col-xl-6 col-lg-6">
                        <div class="top_authors_single">
                            <div class="top_authors_single_inner">
                                <div class="top_authors_image">
                                    <img src="assep/images/resources/top-authors-img-4.jpg" alt="">
                                </div>
                                <div class="top_authors_content">
                                    <h3>Jessica Brown</h3>
                                    <h4>Beauty</h4>
                            ...
                            <div class="top_authors_single_inner">
                                <div class="top_authors_image">
                                    <img src="assep/images/resources/top-authors-img-5.jpg" alt="">
                                </div>
                                <div class="top_authors_content">
                                    <h3>Kevin Martin</h3>
                                    <h4>Cafe Manager</h4>
                            ...
                            <div class="top_authors_single_inner">
                                <div class="top_authors_image">
                                    <img src="assep/images/resources/top-authors-img-6.jpg" alt="">
                                </div>
                                <div class="top_authors_content">
                                    <h3>Christine Eve</h3>
                                    <h4>traveler</h4>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="footer-widget__column footer-widget__about wow fadeInUp" data-wow-delay="100ms">
                            <div class="footer-widget__logo">
                                <a href="#"><img src="assep/images/resources/footer-logo.png" alt=""></a>
                            </div>
